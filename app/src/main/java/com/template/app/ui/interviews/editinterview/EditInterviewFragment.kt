package com.template.app.ui.interviews.editinterview
...
import com.template.app.databinding.EditInterviewFragmentBinding
...
class EditInterviewFragment : Fragment() {
    ...
    companion object {
        ...
        fun createBundle(requestKeyEditInterview: String, interview: Interview): Bundle {
            return Bundle().apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        selectedInterviewer = interview.interviewer
        selectedManager = interview.manager
    ...
    private fun bindInterview() {
        ...
        val dateString = DateUtils.format(interview.interviewDate, outFormat = DateUtils.DateFormat.PRIMARY_DATE)
        binding.interviewDate.setText(dateString)

        binding.hrManager.setText(interview.manager.name)
        binding.interviewer.setText(interview.interviewer.name)
