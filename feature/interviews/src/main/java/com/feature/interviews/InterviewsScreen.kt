...
import com.service.presentation.compose.views.textfield.SearchTextField
import com.service.presentation.compose.views.toolbar.ToolbarPrimary
...
private fun PreviewInterviewsScreen() {
    InterviewsScreen(
        ...
        interviews = PreviewData.getInterviews(),
        onAddNewClick = {}
    )
}
